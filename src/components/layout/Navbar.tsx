...
export function Navbar() {
  ...
  return (
    <>
      <nav
        className={cn(
          "fixed top-0 left-0 right-0 z-50 transition-all duration-500 h-16 lg:h-20 flex items-center",
          scrolled
            ? "bg-background/70 backdrop-blur-xl border-b border-border/40 shadow-[0_2px_20px_-10px_rgba(0,0,0,0.1)]"
        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="font-heading font-bold text-lg tracking-tight">
              <span className="text-foreground">Adiveer</span>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              ...
              className={cn(
                ...
                scrolled
                  ? "text-primary hover:text-primary/80 border border-primary/20 bg-primary/5 backdrop-blur-sm"
